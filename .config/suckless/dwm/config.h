...
static const char dmenuhp[] = "qutebrowser";
...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask,             XK_m,      spawn,          SHCMD("st -c 'cmus' -e cmus") },
    { MODKEY|ShiftMask,             XK_b,      spawn,          SHCMD("st -c 'floating' -g '77x30+500+500' -e bashmount") },
};
